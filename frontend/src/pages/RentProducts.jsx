  ...
  const getFilteredImages = () => {
    ...
    if (appliedFilters.categories && appliedFilters.categories.length > 0) {
      ...
      filtered = filtered.filter(image => {
        ...
        const matches = appliedFilters.categories.some(cat => {
